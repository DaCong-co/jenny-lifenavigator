...
class ContextBuilder:
    ...
    def __init__(
        ...
        self.life_model = LifeModelStore(workspace)
    ...
    def build_system_prompt(
        ...
        # Life Model: il "chi sei in questo momento" dell'utente, subito dopo
        # l'identità (SOUL/USER) e prima delle istruzioni del workspace. Inietta
        # solo i quattro file non vuoti; events/ e pattern_candidates non entrano
        # mai nel prompt (spec §4.3).
        life_model_files = self.life_model.read_context_files()
        if any(life_model_files.values()):
            parts.append(render_template("agent/life_model_section.md", **life_model_files))
